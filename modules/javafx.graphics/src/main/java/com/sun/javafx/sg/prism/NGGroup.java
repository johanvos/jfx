...
System.err.println("NGGroup, GETORDEREDCHILDREN asked for " + this+", returnv " + viewOrderChildren);
            return viewOrderChildren;
        }
System.err.println("NGGroup, GETORDEREDCHILDREN asked for " + this+", return " + children);
        return children;
    }
...
System.err.println("NGGroup, SETORDEREDCHILDREN asked for " + this+" to " + sortedChildren);
