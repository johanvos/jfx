...
fprintf(stderr, "[JVDBG] macrosendkeyevent\n"); \
...
{
fprintf(stderr, "[JVDBG] GlassViewDelegate, sendJavaKeyEvent called, down? %d\n", isDown);
...
fprintf(stderr, "[JVDBG] GlassViewDelegate, sendJavaKeyEvent done\n");
...
fprintf(stderr, "[JVDBG] macro2sendkeyevent\n"); \
